...
export default function CanvasPage() {
    ...
    if (hydrated && (mode === "new" || mode === "recent" || mode === "open")) return <main className="flex h-full items-center justify-center bg-background text-sm text-stone-500">正在打开画布...</main>;
